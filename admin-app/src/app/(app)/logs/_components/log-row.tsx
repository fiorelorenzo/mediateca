...
export function LogRow({ line, style }: { line: LogLine; style?: React.CSSProperties }) {
  ...
  return (
    <div
      style={style}
      className="grid grid-cols-[88px_120px_1fr] items-baseline gap-2 px-2 py-0.5 font-mono text-xs hover:bg-accent/30"
    >
      ...
      <Badge variant="outline" className={`justify-start truncate ${colorClass}`}>{line.container}</Badge>
      <span
